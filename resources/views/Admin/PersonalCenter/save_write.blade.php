                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="form_text form-group">
                            ...
                            <input type="text" maxlength="25" value="{{ $article->name }}" class="form-control" name="title" id="title">
                        </div>
                        <div class="form_text form-group">
                            <label for="acticle_type" class="title_label col-sm-1 control-label no-padding-right">文章类型：</label>
                            <select id="acticle_type" data-select="{{ $article->type }}">
                        ...
                        <div class="form_text form-group">
                            ...
                            <div class="form-control" style="width:88%;height: inherit;">
                                <script name="explain" id="editor" type="text/plain"
                                        style="width:100%;height:500px;">{!! $article->content !!}</script>
                            </div>
                        </div>

                        <div class="row fileupload-buttonbar" style="padding-left:15px;">
                            <div class="upload_img thumbnail col-sm-10">
                                <img id="photo_show" style="height:180px;margin-top:10px;margin-bottom:8px;"  src="{{ $article->image }}" data-default="{{ $article->image }}" data-holder-rendered="true">
                        ...
                        {!! csrf_field() !!}
                        <input type="hidden" id="save_article" value="{{ $article_id }}" />
                    </div>
                </div>
            </div>
        </div>
